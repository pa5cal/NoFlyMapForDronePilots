...
NoFlyMapForDronePilots is an easy way to create a web based browser map with no fly areas for drone pilots.
...
[[https://github.com/pa5cal/NoFlyMapForDronePilots/blob/master/img/NoFlyMapForDronePilots.png|alt=NoFlyMapForDronePilots]]
